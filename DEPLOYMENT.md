...
**Enable auto-deployment in 3 steps:**

1. **Go to:** https://vercel.com/new
2. **Import Git Repository:**
   - Click "Import Git Repository"
   - Select GitHub → Authorize Vercel
   - Choose: `ThandoHlomuka/cosmic-visualizer`
3. **Click "Deploy"**
...
5. Find and select: `ThandoHlomuka/cosmic-visualizer`
6. Click **"Import"**
...
2. **Add GitHub Secrets:**
   - Go to GitHub → `ThandoHlomuka/cosmic-visualizer` → Settings
...
| **GitHub Actions** | https://github.com/ThandoHlomuka/cosmic-visualizer/actions |
...
- [ ] 3D visualization works (WebGL enabled)
- [ ] All planets and moons render correctly
- [ ] Simulation controls are responsive
- [ ] Charts and data export work
...
| Your Repository | https://github.com/ThandoHlomuka/cosmic-visualizer |
...
3. **Open an Issue:** https://github.com/ThandoHlomuka/cosmic-visualizer/issues

---

**Last Updated:** 2026-04-01
**Version:** 1.0 (Auto-Deploy Configured)

🌌 *Deploy your cosmic visualizer to the stars!*
